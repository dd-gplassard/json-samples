...
const lengths = [25_000, 100_000, 250_000, 600_000,700_000,900_000,1_000_000, 1_700_000, 2_500_000];
for (const length of lengths) {
    ...
    fs.writeFileSync(`${formatted}-compact-json-huge-strings.json`, JSON.stringify({hugeValues: hugeValues.map(v => v.toString())}, undefined, 0));
